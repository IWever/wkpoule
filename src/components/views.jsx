    ...
    <div>
      ...
      <div style={{ ...S.card(), marginBottom: 14 }}>
        ...
        <div style={{ fontSize: 13, color: "var(--muted)", lineHeight: 1.8 }}>
          ...
          <strong style={{ color: "var(--text)" }}>KO-fase</strong>. Je verdient
          punten op basis van hoe goed jouw voorspellingen kloppen met de echte
          uitslagen.
        </div>
      </div>
      ...
      <div style={{ ...S.card(), marginBottom: 14 }}>
        ...
        >
          ...
          <div style={{ fontSize: 12, color: "var(--muted)", marginBottom: 8 }}>
            Kies een van de 12 laagst geklasseerde landen. Je verdient meer
            punten naarmate dat land verder de KO-fase haalt:
          </div>
      ...
      >
        ...
        <div>
          ✦ KO-voorspellingen open zodra de admin dit aanzet, soms al halverwege
          de groepsfase.
        </div>
        <div>
          ✦ Hoe verder je land in de KO-fase is, hoe meer punten je verdient met
          de verrassing-voorspelling.
        </div>
        <div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          {[
            ...
            },
            {
              ...
              icon: "🔮",
              label: "Extra vragen",
              desc: "Kampioen, topscorer, Nederland, verrassing en topland",
            },
            {
              key: "koOpen",
              icon: "⚔️",
                  ...
                  <button
                    ...
                    style={{
                      background: u.locked
                        ...
                        : "rgba(63,185,80,.15)",
                      border: `1px solid ${
                        u.locked ? "var(--red)" : "var(--green)"
                      }`,
                      borderRadius: 6,
                      color: u.locked ? "var(--red)" : "var(--green)",
                      padding: "3px 10px",
                      cursor: "pointer",
                      fontSize: 11,
                      fontFamily: "var(--font)",
            ...
            return (
              <div style={{ ...S.card(), marginBottom: 12 }}>
                ...
                <div
                  style={{
                    display: "grid",
                    gridTemplateColumns: "1fr 30px 30px 30px 30px 30px 30px",
                    gap: "0 4px",
                    alignItems: "center",
                    color: "var(--muted)",
                    fontWeight: 700,
          ...
          {KO_STRUCTURE.map((m) => {
            ...
            const awayCandidates =
              awayDesc?.type === "team"
                ...
                : [];
            const candidates = [
              ...new Set([...homeCandidates, ...awayCandidates]),
            ];
      ...
      {tab === "extra" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <div style={S.card()}>
            ...
            >
              ⚽ Officiële topscorer (na toernooi)
            </div>
            <select
              ...
              <select
                ...
                onChange={(e) =>
                  setState((s) => {
                    const ns = {
                      ...s,
                      results: { ...s.results, TOP_SCORER: e.target.value },
                    };
                    persist(ns);
                    return ns;
                  })
