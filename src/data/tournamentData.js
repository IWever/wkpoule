...
const NL_STAGES = [
  "Groepsfase (niet verder)", "Zestiende finale", "Achtste finale",
  "Kwartfinale", "Halve finale", "3e Plaats", "🏆 Wereldkampioen",
];

const SURPRISE_TEAMS = [
  "Haïti", "Oezbekistan", "DR Congo", "Kaapverdië", "Irak", "Jordanië",
  "Panama", "Curaçao", "Nieuw-Zeeland", "Algerije", "Qatar", "Zuid-Afrika",
];
...
const TOP_TEAMS = [
  "Argentinië", "Frankrijk", "Engeland", "Brazilië", "Portugal",
...
export {
  GROUPS, ALL_TEAMS, GROUP_MATCHES, KO_STRUCTURE, NL_STAGES,
  SURPRISE_TEAMS, PTS_SURPRISE, TOP_TEAMS, PTS_TOP_OUT,
  PLAYERS_BY_COUNTRY, PTS_GROUP, PTS_STANDING, PTS_KO, PTS_EXTRA,
  FLAG, TEAM_GROUP, ADMIN_PW, KEY, SESSION_KEY,
};